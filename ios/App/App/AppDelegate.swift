...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Strudel VibeLive: configure AVAudioSession before the WebView's AudioContext starts,
    // so the first play routes to the speaker with low latency. See packages/iosbridge.
